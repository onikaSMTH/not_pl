...
class AllProductsSc extends StatefulWidget {
  ...
  AllProductsSc(
      {this.appBarTitle = "", this.isAll = false, this.isFav = false, this.isMy = false});
...
class _AllProductsScState extends State<AllProductsSc> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions:widget.isMy? [InkWell(child: const Padding(
          ...
          body: FutureBuilder(
            future:  HttpService().getProducts(),
             ...
             if(snapshot.connectionState == ConnectionState.done) {
               ...
               Provider.of<Products>(context).setProducts(products);
               }
               return GridView.builder(
                 ...
                 gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                     childAspectRatio: 1,
                     mainAxisExtent: widget.isMy ? MediaQuery
                         .of(context)
                         .size
                     ...
                     crossAxisSpacing: 5, crossAxisCount: widget.isMy ? 1 : 2),
               );
             }
            else {
    ...
    routes: {
          ProductDetails.route: (_){return ProductDetails();}
    },);
  }
}
